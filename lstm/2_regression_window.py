...
"""
Esto es si queremos usar una ventana de tiempo para predecir el futuro. Es decir, predecir t, usando t-1, t-2, t-3
"""
np.random.seed(42)
...
# We can see here that we have an average error of less than 13 euro for both (highly past dependence)
